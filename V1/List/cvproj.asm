...
_battery_charTable:
	.DB  0x4E,0x51,0x53,0x57,0x5F,0x5F,0x5F,0xC0
_switch_charTable:
...
_0x0:
	.DB  0x55,0x73,0x65,0x72,0x20,0x64,0x65,0x66
	.DB  0x69,0x6E,0x65,0x64,0xA,0x63,0x68,0x61
...
; 0001 0025     define_char(power_charTable, 1);
	LDI  R30,LOW(_power_charTable*2)
	LDI  R31,HIGH(_power_charTable*2)
	ST   -Y,R31
	ST   -Y,R30
	LDI  R26,LOW(1)
	RJMP _0x2020003
